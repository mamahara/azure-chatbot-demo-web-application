...
import { ConversationExpirationEventArgs, ConversationParticipantsChangedEventArgs, ConversationTranslationCanceledEventArgs, ConversationTranslationEventArgs, Participant } from "./Exports";
 ...
 */
export declare class ConversationTranslator implements IConversationTranslator, IDisposable {
    private privSpeechRecognitionLanguage;
    private privProperties;
    private privAudioConfig;
    private privSpeechTranslationConfig;
